...
The repo it lives in: <https://github.com/Hawaiine/Oasisic-Skills/tree/main/skills/stealth-browser-automation>
...
- [`references/test-targets.md`](./references/test-targets.md) — canonical detection sites with expected baseline behavior (what passing/failing each one tells you about the stack), supplementary targets (Kasada, GeeTest, DataDome, bot.incolumitas.com), and a recorded baseline run.
